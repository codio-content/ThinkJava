...
Figure 16.2 shows part of the resulting HTML page generated by Javadoc. Notice the relationship between the Javadoc comment (in the source code) and the resulting documentation (in the HTML page).

![Figure 16.2 HTML documentation for `isSingleDigit`.](figs/javadoc.jpg)

**Figure 16.2 HTML documentation for `isSingleDigit`.**
